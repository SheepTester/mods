...
public class MyEntitySlime extends EntityLiving implements IMob
{
    ...
    public MyEntitySlime(World par1World)
    {
        super(par1World);
    ...
    {
        return "iconcrack_" + Main.Jelly.itemID; //RenderGlobal.java
    }
    ...
    protected MyEntitySlime createInstance()
    {
        return new MyEntitySlime(this.worldObj);
    }
    ...
    public void setDead()
    {
        ...
        if (!this.worldObj.isRemote && i > 1 && this.getHealth() <= 0.0F)
        {
            ...
            for (int k = 0; k < j; ++k)
            {
                ...
                MyEntitySlime entityslime = this.createInstance();
