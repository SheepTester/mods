...
public class MyEntityFourm extends EntityMob implements IBossDisplayData, IRangedAttackMob
{
    ...
    private static final IEntitySelector attackEntitySelector = new MyFourmAttackFilter();

    public MyEntityFourm(World par1World)
    {
        super(par1World);
    ...
    {
        this.dropItem(Main.MyBlock_4.blockID, 1);
    }
